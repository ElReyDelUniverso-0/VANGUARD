// Ronda 24 — bump honesto: +30 enlaces verificados con curl (9 pages/pastes + 21 shorts con Location verificado)
...
(async () => {
  await db.$executeRawUnsafe(`UPDATE site_counter SET n = n + 30 WHERE k = 'shares:external'`);
